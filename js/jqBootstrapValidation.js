  ...
  var defaults = {
    ...
    methods: {
      init(options) {
        ...
        $(uniqueForms).bind('submit', function (e) {
          ...
          $inputs.each((i, el) => {
            const $this = $(el);
            const $controlGroup = $this.parents('.form-group').first();
            if (
        ...
        return this.each(function () {
          ...
          $.each(validatorNames, (i, el) => {
            ...
            $.each(
              ...
              (validatorType, validatorTemplate) => {
            ...
            if (!foundValidator && settings.builtInValidators[el.toLowerCase()]) {
              ...
              if (validatorType === 'shortcut') {
                ...
                $.each(
                  settings.validatorTypes,
                  (validatorTemplateType, validatorTemplate) => {
          ...
          $this.bind(
            'submit.validation',
            () => $this.triggerHandler('change.validation', {
              submitting: true,
            }),
          );
          $this.bind(
        ...
        return this.each(
          function () {
            const
              $this = $(this);
            const $controlGroup = $this.parents('.form-group').first();
            const $helpBlock = $controlGroup.find('.help-block').first();
      ...
      collectErrors(includeEmpty) {
        ...
        this.each((i, el) => {
          ...
          const errors = $el.triggerHandler('validation.validation', {
            includeEmpty: true,
          });
    ...
    validatorTypes: {
      callback: {
        ...
        validate($this, value, validator) {
          ...
          if (validator.lastFinished === true) {
            ...
            const rrjqbvValidator = validator;
      ...
      match: {
        name: 'match',
        init($this, name) {
          const element = $this.parents('form').first().find(`[name="${$this.data(`validation${name}Match`)}"]`).first();
